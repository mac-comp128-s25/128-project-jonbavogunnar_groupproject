...
public class MatchEngine {
    ...
    public static MatchResults matchResults(Team team1, Team team2) {
        ...
        double team1Chance = (double) team1Off / (team2Def + 0.5);
        double team2Chance = (double) team2Off / (team1Def + 0.5);
    ...
    private static int simulateGoals(double chance) {
        double adjusted = chance * 1.8;
        int goals = 0;
        while (Math.random() < (adjusted / (goals + 4))) {
            goals++;
        }
        return goals;
    }
